...
const ExpenditureCard = ({ doughnutChartData, currency }: { doughnutChartData: any, currency: string }) => {
  ...
  return (
    <Can I="view" a="view_expenditure">
      {doughnutChartData?.expenditure_category?.labels || !doughnutChartData?.expenditure_category?.labels.some((element: any) => element === null) || doughnutChartData?.expenditure_category?.data || doughnutChartData?.expenditure_brands?.labels || !doughnutChartData?.expenditure_brands?.labels.some((element: any) => element === null) || doughnutChartData?.expenditure_brands?.data &&
