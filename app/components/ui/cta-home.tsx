...
const CtaHome: React.FC<PropType> = ({ totalNotificationCount }) => {
  return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-y-3 gap-x-3 lg:gap-x-6 place-content-center">
        ...
        >
          <span className="relative flex items-center gap-1">
            <div data-tooltip="Notifications" className="relative">
              {/* Notification Badge */}
              <div className="absolute bg-semantic-danger-500 h-[20px] min-w-[20px] rounded-full right-[4px] top-[-4px] flex items-center justify-center text-sm text-white font-medium">
