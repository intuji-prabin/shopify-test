...
const getDate = () => {
    ...
    const differenceInDays = Math.floor((today.getTime() - januaryFirst.getTime()) / (24 * 60 * 60 * 1000));
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                <div className="p-6 space-y-8 bg-white">
                    <div className="flex flex-wrap justify-between gap-3">
                        <h4>Monthly Spend</h4>
                        <p className="text-base font-medium lg:text-lg text-grey-900">December</p>
                    </div>
                    <div className="flex flex-wrap justify-between gap-3">
                ...
                <div className="p-6 space-y-8 bg-white">
                    <div className="flex flex-wrap justify-between gap-3">
                        ...
                        <ul className="text-base font-medium lg:text-lg text-grey-900" dangerouslySetInnerHTML={{
                            __html: currentDate,
                        }}></ul>
                    </div>
                    <div className="flex flex-wrap justify-between gap-3">
