      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <div className="p-6 space-y-8 bg-white">
          <div className="grid items-center grid-cols-1 md:grid-cols-2 gap-y-1 gap-x-3">
            <h4>Monthly Spend</h4>
            <p className="text-base font-medium lg:text-lg text-grey-900 md:text-right">{currentDate.currentLongMonth}</p>
          </div>
          <div className="grid items-center grid-cols-1 md:grid-cols-2 gap-y-1 gap-x-3">
        ...
        <div className="p-6 space-y-8 bg-white">
          <div className="grid items-center grid-cols-1 md:grid-cols-2 gap-y-1 gap-x-3">
            ...
            <ul className="text-base font-medium lg:text-lg text-grey-900 md:text-right">
              <li>Jan 1 - {currentDate.currentDate} {currentDate.currentLongMonth} {currentDate.currentYear}</li>
              <li className='text-sm font-normal md:text-right'>({currentDate.daysIntoYear} Days into the year)</li>
            </ul>
          </div>
          <div className="grid items-center grid-cols-1 md:grid-cols-2 gap-y-1 gap-x-3">
            <div className="space-y-2">
