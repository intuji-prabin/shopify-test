  ...
  'cursor-pointer duration-150 flex items-center justify-center gap-2 uppercase p-2 border-solid',
  {
    variants: {
      variant: {
        ...
        secondary: 'bg-secondary-500 py-4 px-8 font-bold italic leading-6 text-lg text-grey-800 max-h-14 hover:bg-grey-800 hover:text-white',
        ghost:
        ...
        disabled: 'text-grey-400 bg-grey-200 cursor-not-allowed pointer-events-none',
      },
      size: {
