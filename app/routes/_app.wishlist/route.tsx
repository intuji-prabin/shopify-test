      ...
      case 'POST':
        try {
          ...
          if (cartInfo?.bulkCart && cartInfo?.bulkCart == 'true') {
            const bulkCart = await addedBulkCart(
              cartInfo,
              context,
              accessTocken,
              request,
      ...
      {finalWishList.length > 0 ? (
        <div className="pt-6">
          <div className="flex justify-between">
            <BackButton className="capitalize" title="Wishlist" />
                    ...
                    onClick={() => {
                      ...
                      table.getSelectedRowModel().flatRows.map((item) => {
                        ...
                        const quantityVal = Number(
                          formData.get(`${item.original.productId}_quantity`),
                        );
                        const moqVal = Number(
        ...
        <div className="py-80">
          <div className="flex justify-center">
            <div className="text-center">
              ...
              <Link
                className="inline-block px-6 py-2 text-sm italic font-bold leading-6 uppercase text-neutral-white bg-primary-500 hover:bg-primary-600 disabled:bg-grey-50"
